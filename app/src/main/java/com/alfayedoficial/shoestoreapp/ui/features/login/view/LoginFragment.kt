...
import com.alfayedoficial.shoestoreapp.utils.ValidationInputs.validationAuthTextInputEditText
...
class LoginFragment : BaseFragment<FragmentLoginBinding>() {
    ...
    private fun navigate() = navController.navigate(R.id.action_loginFragment_to_onboardFragment)
